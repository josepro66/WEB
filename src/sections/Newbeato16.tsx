...
const Newbeato16: React.FC = () => {
  return (
    <section className="relative h-screen w-full">
      {/* Fondo semi-transparente para ver las partículas detrás */}
      <div 
        className="absolute inset-0"
        style={{ 
          backgroundColor: 'rgba(0, 0, 0, 0.6)',
          zIndex: 999998  // Just below the image background
        }}
      />
      ...
      <div 
        ...
        style={{ 
          backgroundImage: `url(${import.meta.env.BASE_URL}/images/fondonewbeato16.png)`,
          zIndex: 1000000
        }}
      />
      
      {/* Content */}
      <div className="relative h-full flex flex-col items-center justify-start pt-9 px-4" style={{ zIndex: 1000001 }}>
        {/* Title */}
        <motion.div
        ...
        {/* Imagen del producto */}
        <div className="w-full h-[400px] md:h-[600px] relative flex items-center justify-center -mt-24" style={{ zIndex: 1000002 }}>
          <img 
        ...
        >
          <p className="text-lg text-gray-300 mb-3 font-inter" style={{ zIndex: 1000005 }}>
