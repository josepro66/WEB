...
export function getWavoCurrencyConfig(currency) {
  const map = {
    USD: { accountId: "512321", amount: "500.00", symbol: "$", language: "en", url: PAYU_SANDBOX_URL },
    COP: { accountId: "512322", amount: "2000000", symbol: "$", language: "es", url: PAYU_SANDBOX_URL },
  };
  return map[currency] || map.USD;
}
