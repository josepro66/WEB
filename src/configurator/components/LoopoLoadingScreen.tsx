...
const LoopoLoadingScreen: React.FC<LoopoLoadingScreenProps> = ({ isVisible, onComplete }) => {
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            Features: Loop controller with 4 assignable buttons and LED indicators.
          </motion.div>
          ...
          >
            Cargando LOOPO... {Math.round(progress)}%
          </motion.div>
