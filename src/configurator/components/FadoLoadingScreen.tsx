...
const FadoLoadingScreen: React.FC<FadoLoadingScreenProps> = ({ isVisible, onComplete }) => {
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            Features: Compact design with 4 assignable knobs and LED indicators.
          </motion.div>
          ...
          >
            Cargando FADO... {Math.round(progress)}%
          </motion.div>
