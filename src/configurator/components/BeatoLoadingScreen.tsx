...
const BeatoLoadingScreen: React.FC<BeatoLoadingScreenProps> = ({ isVisible, onComplete }) => {
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            Features: Metal body, 8 ARCADE buttons, and 4 assignable knobs.
          </motion.div>
          ...
          >
            Cargando BEATO8... {Math.round(progress)}%
          </motion.div>
