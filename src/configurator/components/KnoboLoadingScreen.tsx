...
const KnoboLoadingScreen: React.FC<KnoboLoadingScreenProps> = ({ isVisible, onComplete }) => {
    ...
    <AnimatePresence>
      {isVisible && (
        ...
        >
          ...
          >
            Features: Professional knob controller with 4 assignable knobs and LED feedback.
          </motion.div>
          ...
          >
            Cargando KNOBO... {Math.round(progress)}%
          </motion.div>
