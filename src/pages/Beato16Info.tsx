      ...
      <section className="relative pb-20 px-1">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">1 Fader</h3>
              <p className="text-gray-300">Controlador deslizante de alta precisión para mezcla y control de parámetros en tiempo real.</p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• 16 botones arcade RGB personalizables</li>
                  <li>• 4 teclas táctiles estilo juego</li>
                  <li>• 1 fader de precisión</li>
          ...
          >
            <div className="mb-6">
              <p className="text-5xl font-bold text-white">$1.000.000 COP</p>
