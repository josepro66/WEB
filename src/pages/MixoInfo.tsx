        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 font-gotham">
              Controlador de Mezcla Profesional para DJs
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="w-1/2 pl-8">
              <p className="text-xl text-gray-300 font-gotham leading-relaxed">
                El MIXO es un controlador de mezcla profesional diseñado específicamente para DJs que buscan un control total sobre sus sets. Con 4 canales de mezcla, EQ completo, efectos integrados y crossfader de alta precisión, ofrece la experiencia de mezcla más auténtica y profesional.
              </p>
            </div>
          </motion.div>
          ...
          >
            <div className="max-w-4xl mx-auto">
              <p className="text-xl text-gray-300 font-gotham leading-relaxed">
                Su diseño ergonómico y controles táctiles de alta calidad lo convierten en la herramienta perfecta para presentaciones en vivo, estudios de grabación y sesiones de DJ profesional.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="w-1/2 pr-8">
              ...
              <p className="text-xl text-gray-300 font-gotham leading-relaxed">
                Con una construcción robusta y controles de mezcla de nivel profesional, el MIXO está diseñado para resistir el uso intensivo en clubes y eventos, proporcionando la confiabilidad que necesitas para tus presentaciones más importantes.
              </p>
            </div>
          ...
          >
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">4 Canales</h3>
              <p className="text-gray-300">Control completo de 4 canales de mezcla con faders de 60mm de alta precisión.</p>
            </div>

            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">EQ Completo</h3>
              <p className="text-gray-300">Equalizador de 3 bandas (High, Mid, Low) en cada canal para control total del sonido.</p>
            </div>

            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">Efectos Integrados</h3>
              <p className="text-gray-300">Efectos de audio profesionales integrados para enriquecer tus mezclas.</p>
            </div>

            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">Crossfader</h3>
              <p className="text-gray-300">Crossfader de alta precisión con curva ajustable para transiciones perfectas.</p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">Diseño Profesional</h3>
              <p className="text-gray-300">Construcción robusta diseñada para el uso intensivo en clubes y eventos.</p>
            </div>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• 4 canales de mezcla con faders de 60mm</li>
                  <li>• EQ de 3 bandas por canal</li>
                  <li>• Crossfader de alta precisión</li>
                  <li>• Efectos integrados</li>
                </ul>
              </div>
              <div>
