        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="max-w-4xl mx-auto">
              <p className="text-xl text-gray-300 font-gotham leading-relaxed">
                Ideal para guitarristas, vocalistas, loopers y performers en vivo que necesitan un control físico sobre sus efectos y parámetros sin interrumpir su interpretación.
              </p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="w-1/2 pr-8">
              <h2 className="text-3xl font-bold mb-6 text-cyan-400">Control Manos Libres</h2>
              <p className="text-xl text-gray-300 font-gotham leading-relaxed">
                Con sus footswitches robustos y perillas asignables, Loopo se integra perfectamente con tu DAW, pedalera de efectos o cualquier equipo compatible con MIDI, dándote el control total sobre tu performance sin sacrificar la expresión musical.
              </p>
            </div>
          ...
          >
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">4 Footswitches</h3>
              <p className="text-gray-300">Interruptores de pedal de alta resistencia para activar efectos, clips o funciones sin usar las manos.</p>
            </div>

            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">4 Knobs Asignables</h3>
              <p className="text-gray-300">Perillas rotativas para ajustar volúmenes, efectos y parámetros en tiempo real durante la performance.</p>
            </div>

            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">Control Hands-Free</h3>
              <p className="text-gray-300">Diseñado específicamente para artistas que necesitan tocar o cantar mientras controlan su setup.</p>
            </div>
            ...
            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              ...
              <p className="text-gray-300">Compatible con todos los DAWs y software MIDI principales sin necesidad de drivers.</p>
            </div>

            <div className="bg-gray-800/50 backdrop-blur-sm p-6 rounded-lg border border-cyan-500/20">
              <h3 className="text-xl font-bold text-cyan-400 mb-3">Construcción Robusta</h3>
              <p className="text-gray-300">Diseñado para soportar la intensidad de las presentaciones en vivo sobre el suelo o en pedaleboards.</p>
            </div>
          </motion.div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2 text-gray-300">
                  <li>• 4 footswitches de alta resistencia</li>
                  <li>• 4 knobs asignables</li>
                  <li>• Cuerpo compacto y robusto</li>
                </ul>
              </div>
              <div>
          ...
          >
            <div className="mb-6">
              <p className="text-5xl font-bold text-white">$500.000 COP</p>
