...
function FadoPrimitive() {
  const gltf = useGLTF(new URL('/models/FADO.glb', import.meta.url).href)
  useLayoutEffect(() => {
...
useGLTF.preload(new URL('/models/FADO.glb', import.meta.url).href)

export default function FadoViewer({ className }: Props) {
