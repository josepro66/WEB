...
function KnoboPrimitive() {
  const gltf = useGLTF(new URL('/models/KNOBO.glb', import.meta.url).href)
  useLayoutEffect(() => {
...
useGLTF.preload(new URL('/models/KNOBO.glb', import.meta.url).href)

export default function KnoboViewer({ className }: Props) {
