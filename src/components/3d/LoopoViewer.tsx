...
function prepareModel(scene: THREE.Object3D, targetSize = 2.6, ringColor = 0x1c1c1c) {
...
function LoopoPrimitive() {
  const gltf = useGLTF(new URL('/models/LOOPO.glb', import.meta.url).href)
  useLayoutEffect(() => {
...
useGLTF.preload(new URL('/models/LOOPO.glb', import.meta.url).href)

export default function LoopoViewer({ className }: Props) {
