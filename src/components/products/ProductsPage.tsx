      ...
      <div className="relative z-10 space-y-2">
        ...
        <div className="flex items-center justify-between pt-2">
          ...
          <motion.button
            ...
            transition={{ duration: 0.3 }}
            onClick={() => {
                if (product.id === 'beato16') {
                  window.location.href = '/beato16info';
                } else if (product.id === 'beato') {
                  window.location.href = '/beato8info';
                } else if (product.id === 'mixo') {
                  window.location.href = '/mixoinfo';
                } else if (product.id === 'fado') {
                  window.location.href = '/fadoinfo';
                } else if (product.id === 'knobo') {
                  window.location.href = '/knoboinfo';
                } else if (product.id === 'loopo') {
                  window.location.href = '/loopoinfo';
                } else {
                  // Para otros productos, ir al configurador con el producto específico
                  window.location.href = `/configurator?product=${product.id}`;
                }
              }}
          >
...
function ProductsPage() {
  ...
  React.useEffect(() => {
    const handleFullscreenChange = () => {
      ...
      console.log('Pantalla completa:', isFullscreen); // Debug
    };
  ...
  const splideOptions = {
    ...
    snap: true,
    keyboard: true,
    arrowPath: 'M15.41 7.41L14 6l-6 6 6 6 1.41-1.41L10.83 12z',
    breakpoints: {
      1024: {
        perPage: 3,
        autoWidth: false,
